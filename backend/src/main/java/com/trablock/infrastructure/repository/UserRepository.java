package com.trablock.infrastructure.repository;

import com.trablock.domain.EmailConfirm;
import com.trablock.domain.User;
import com.trablock.domain.exception.RepositoryException;
import com.trablock.domain.repository.IUserRepository;
import com.trablock.infrastructure.repository.factory.UserFactory;
...
public class UserRepository implements IUserRepository {
	...
	public int isDupEmail(String email) {
		StringBuilder sbSql =  new StringBuilder("SELECT count(*) FROM users ");
